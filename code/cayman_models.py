...
# Unusable with distance ML - can't evaluate fit of answer to sentence
def distanceModel(glove, question, distfunc=cosine, threshold=2):
...
def unigramModel(unigrams, bigrams, question, distfunc=cosine, threshold=2):
...
def bigramModel(unigrams, bigrams, question, distfunc=cosine, threshold=2):
...
# def backOffModel(question, distfunc=cosine, threshold=2):
#     if(not rev):
...
# def randomModel(question, distfunc=cosine, threshold=2):
